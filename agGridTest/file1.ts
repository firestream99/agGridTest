/// <reference path="./Scripts/Vendor/ag-grid-community/main.d.ts" />

//import { GridApi } from "./Scripts/Vendor/ag-grid-community/dist/lib/gridApi";
//import { Grid } from "./Scripts/Vendor/ag-grid-community/dist/lib/grid";
import { Grid } from "./Scripts/Vendor/ag-grid-community/main"; 
//import Grid = require("./Scripts/Vendor/ag-grid-community/main");

//declare function Grid(GridDiv: any, gridOptions: any): void;
...
document.addEventListener('DOMContentLoaded', function () {
    let gridDiv: HTMLElement = <HTMLElement>document.querySelector('#myGrid');
